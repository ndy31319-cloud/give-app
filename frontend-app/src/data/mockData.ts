...
export const mockRequestPosts: RequestPostRecord[] = [
  { requestId: 'request_1', memberId: 'member_1', title: '아기 옷 필요해요', content: '돌 지난 아기 옷이 필요합니다. 겨울옷이면 더 좋고 깨끗하게 입을게요.', createdFrom: 'app', urgency: 'high', status: 'open', createdAt: isoHoursAgo(4), updatedAt: isoHoursAgo(4) },
  { requestId: 'request_2', memberId: 'member_3', title: '노트북 구합니다', content: null, createdFrom: 'web', urgency: 'urgent', status: 'pickup_pending', createdAt: isoHoursAgo(12), updatedAt: isoHoursAgo(10) },
  { requestId: 'request_3', memberId: 'member_10', title: '생활용 가전 필요', content: '이사 후 소형 가전이 부족해서 상태 괜찮은 물품을 찾고 있습니다.', createdFrom: 'app', urgency: 'normal', status: 'completed', createdAt: isoDaysAgo(2), updatedAt: isoDaysAgo(1) },
  { requestId: 'request_4', memberId: 'member_12', title: '아이 책상 요청', content: '초등학생 공부용 책상이 필요합니다.', createdFrom: 'app', urgency: 'high', status: 'canceled', createdAt: isoDaysAgo(4), updatedAt: isoDaysAgo(3) },
];
...
function mapRequestToPost(record: RequestPostRecord): Post {
  ...
  return {
    ...
    title: record.title,
    description: record.content ?? '',
    createdFrom: record.createdFrom ?? 'app',
    category: product?.category ?? 'household',
    productId: product?.productId,
    itemName: item?.itemName,
    itemCondition: item?.itemCondition,
