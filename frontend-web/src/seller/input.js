...
function SellerInput() {
  ...
  return (
    <div
      className="bg-[#F8F9FA] min-h-screen p-8"
      style={{
    ...
    >
      ...
      <form
        ...
        className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 pb-20"
      >
        {/* 왼쪽: 사진 업로드 영역 */}
        <div className="space-y-4">
          <label className="text-[22px] font-bold text-[#333] ml-2">
            물품 사진 (최대 1장)
          </label>
          <div
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            <div className="border-2 border-[#E5E7EB] rounded-[20px] transition-all bg-white focus-within:border-[#22C55E] px-6 py-5">
              <input
                type="text"
                placeholder="나눔 물품 제목을 입력하세요"
                required
                className="w-full text-[20px] outline-none placeholder:text-gray-300"
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="border-2 border-[#E5E7EB] rounded-[20px] transition-all bg-white focus-within:border-[#22C55E] px-6 py-5">
              <select
                ...
                required
                style={selectStyle}
                className="w-full text-[20px] outline-none bg-transparent text-gray-500"
              >
          ...
          <div className="space-y-3">
            ...
            <div className="border-2 border-[#E5E7EB] rounded-[20px] transition-all bg-white focus-within:border-[#22C55E] px-6 py-5">
              <textarea
                placeholder="나눔 물품에 대한 설명을 입력하세요"
                rows="4"
                required
                className="w-full text-[20px] outline-none placeholder:text-gray-300 resize-none"
              ></textarea>
            </div>
          </div>
          ...
          <div className="pt-4">
            <button
              type="submit"
              className="w-full bg-[#22C55E] text-white py-6 rounded-[28px] text-[24px] font-bold shadow-lg active:scale-[0.98] transition-all hover:bg-[#1ea951]"
            >
              등록 완료
            </button>
          </div>
