    ...
    >
      ...
      <div className="grid grid-cols-2 gap-8 mb-10">
        ...
        <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 flex flex-col items-center justify-center gap-2">
          ...
          <span className="text-[40px] font-bold text-[#22C55E]">0건</span>
        </div>
      </div>

      <div className="space-y-4">
        <button onClick={() => navigate('/manage-items')} className="w-full bg-white p-8 rounded-[28px] flex justify-between items-center border border-[#E5E7EB] hover:bg-gray-50 active:scale-[0.98]">
        ...
        <button onClick={() => navigate('/setting-seller')} className="w-full bg-white p-8 rounded-[28px] flex justify-between items-center border border-[#E5E7EB] hover:bg-gray-50 active:scale-[0.98]">
